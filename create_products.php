<?php
  ...
  $parents=$productsController->getParents();
  ...
  if(isset($_POST['add']))
  {
   // var_dump($_POST);
    ...
    if(!($error))
    {
        $result=$productsController->addProducts($parent,$name,$model,$brand,$color);
        if($result)
        {
                  ...
                  <label for="" class="form-label">Name</label>
                   ...
                   <select name="parent" id="" class="form-control">
                         <?php
                           ...
                           {
                            // echo "<option value='".$parents[$index]['name']."'>.$parents[$index]['name'].</option>";
